...
public class ManageListFavoriteAdapter extends ArrayAdapter<Item> {
    Context context;
    List<Item> lists;
    TextView tv_title, tv_link, tv_date;
    ImageView iv_news;
    ManageListFavorite manageListFavorite;

    public ManageListFavoriteAdapter(@NonNull Context context, ManageListFavorite
            manageListFavorite, List<Item> list) {
        super(context, 0, list);
        this.context = context;
        this.lists = list;
        this.manageListFavorite = manageListFavorite;
    }
